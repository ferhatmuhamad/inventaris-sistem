            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5><strong>Tambah Data Stok Keluar</strong></h5>
                            ...
                            <div class="container wrap mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="id_customer" id="id_customer" class="form-control @error('id_product') is-invalid @enderror" required data-live-search="true">
                                            @if ($data['customer']->count() == 0)
                                                <option value="">Belum Ada Customer</option>
                                            @else
                                                <option value="">-- Pilih --</option>
                                                @foreach ($data['customer'] as $customer)
                                                    <option value="{{$customer->id}}">{{$customer->nama_customer}} | {{$customer->email_customer}} | {{$customer->telepon_customer}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div id="clone1">
                                        <div class="row input_fields_wrap">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="number" name="bill[]" id="bill" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
