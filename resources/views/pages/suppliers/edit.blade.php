            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <h5><strong>({{ $item->nama_supplier }})</strong></h5>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        type="text"
                                        name="nama_supplier"
                                        value="{{ old('nama_supplier') ? old('nama_supplier') : $item->nama_supplier }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        value="{{ old('alamat_supplier') ? old('alamat_supplier') : $item->alamat_supplier }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        type="text"
                                        name="email_supplier"
                                        value="{{ old('email_supplier') ? old('email_supplier') : $item->email_supplier }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        value="{{ old('telepon_supplier') ? old('telepon_supplier') : $item->telepon_supplier }}"
                                        class="form-control @error('telepon_supplier') is-invalid @enderror">
